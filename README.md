...
- [Política de privacidad](https://jorgejiro.es/apps/sleep-noise/privacidad/) — el HTML vive en el repositorio `vps` (ver [`docs/privacy-policy/LEEME.md`](docs/privacy-policy/LEEME.md))
